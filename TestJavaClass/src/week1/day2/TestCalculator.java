package week1.day2;
/*
 * 1. Create a class "Calculator" with below methods
...
2. Create another class as MyCalculator and call all the methods from Calculator and print the results
 */
...
{
	int sumOfResult = num1 + num2 + num3;
	return sumOfResult;
}

public int sub(int num1,int num2)
{
	int subOfResult = num1 - num2;
	return subOfResult;
}

public double multiple(double num1,double num2)
{
	double multipleOfResult = num1 * num2;
	return multipleOfResult;
}

public float divide(float num1,float num2)
{
	float divideOfResult = num1 / num2;
	return divideOfResult;
}
